...
import FOOTER_LINKS from "../../assest/data";
import FOOTER_CONTACT_INFO from "../../assest/FOOTER_CONTACT_INFO";
import SOCIALS from "../../assest/SOCIALS";

const Footer = () => {
  return (
    <footer className="flexCenter pb-24 pt-20">
      <div className="max_pad_container flex w-full flex-col gap-14">
